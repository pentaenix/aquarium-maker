...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ks(e,t,n){let r=new Float32Array(hs),i=new q(0,1,0);return new qa({name:`SphericalGaussianBlur`,defines:{n:hs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ms(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function As(){return new qa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ms(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function js(){return new qa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ms(),fragmentShader:`
	...
	`}var Ns=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Xc(i,i.VERTEX_SHADER,y),S=Xc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=nl(i,x,`vertex`),n=nl(i,S,`fragment`);W(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    </div>`}var $d=class{settings;root;callbacks;selectedCorner=`frontLeft`;linkCorners=!1;constructor(e,t,n){this.root=e,this.settings=t,this.callbacks=n,this.render(),this.bind(),this.refresh()}setSettings(e){this.settings=e,this.refresh()}render(){this.root.innerHTML=`
    ...
    `}bind(){for(let e of Xd){let t=this.root.querySelector(`[data-range-key="${e.key}"]`),n=this.root.querySelector(`[data-number-key="${e.key}"]`);if(!t||!n)continue;let r=t=>{let n=Number.parseFloat(t);if(!Number.isFinite(n))return;let r=this.settings;r[e.key]=n,Yd(this.settings),this.refresh(),this.callbacks.onChange(this.settings,e.structural??!1)};t.addEventListener(`input`,()=>r(t.value)),n.addEventListener(`change`,()=>r(n.value))}for(let e of[`waterColor`,`sandColor`]){let t=this.root.querySelector(`[data-color-key="${e}"]`),n=this.root.querySelector(`[data-color-text-key="${e}"]`);t.addEventListener(`input`,()=>{this.settings[e]=t.value,n.value=t.value.toUpperCase(),this.callbacks.onChange(this.settings,!1)}),n.addEventListener(`change`,()=>{let r=n.value.trim();/^#[0-9a-f]{6}$/i.test(r)&&(this.settings[e]=r,t.value=r,this.callbacks.onChange(this.settings,!1)),this.refresh()})}this.root.querySelectorAll(`[data-corner]`).forEach(e=>{e.addEventListener(`click`,()=>{this.selectedCorner=e.dataset.corner,this.refreshCornerEditor()})});let e=this.root.querySelector(`#corner-range`);e.addEventListener(`input`,()=>{let t=Number.parseFloat(e.value);if(this.linkCorners)for(let e of Object.keys(this.settings.radii))this.settings.radii[e]=t;else this.settings.radii[this.selectedCorner]=t;Yd(this.settings),this.refreshCornerEditor(),this.callbacks.onChange(this.settings,!0)}),this.root.querySelector(`#link-corners`).addEventListener(`click`,e=>{this.linkCorners=!this.linkCorners;let t=e.currentTarget;t.setAttribute(`aria-checked`,String(this.linkCorners)),t.classList.toggle(`is-on`,this.linkCorners)}),this.root.querySelectorAll(`[data-corner-preset]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Math.min(this.settings.width,this.settings.depth),n=e.dataset.cornerPreset;n===`panoramic`?this.settings.radii={frontLeft:t*.12,frontRight:t*.12,backRight:t*.033,backLeft:t*.033}:n===`balanced`?this.settings.radii={frontLeft:t*.085,frontRight:t*.085,backRight:t*.085,backLeft:t*.085}:this.settings.radii={frontLeft:.02,frontRight:.02,backRight:.02,backLeft:.02},Yd(this.settings),this.root.querySelectorAll(`[data-corner-preset]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),this.refreshCornerEditor(),this.callbacks.onChange(this.settings,!0)})}),this.root.querySelector(`#randomize-sand`).addEventListener(`click`,()=>{this.settings.sandSeed=Math.floor(Math.random()*1e9),this.callbacks.onChange(this.settings,!1)}),document.querySelector(`#reset-button`).addEventListener(`click`,()=>{let e=Jd(qd);this.settings=e,this.callbacks.onReset(e),this.refresh()}),document.querySelector(`#share-button`).addEventListener(`click`,this.callbacks.onShare),document.querySelector(`#download-button`).addEventListener(`click`,this.callbacks.onDownload),document.querySelectorAll(`[data-view]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.view;this.callbacks.onView(t),t!==`fit`&&(document.querySelectorAll(`[data-view]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`))})})}formatValue(e,t){if(e.format)return e.format(t);let n=e.step<.01?3:e.step<.1?2:1;return`${t.toFixed(n)}${e.unit?` ${e.unit}`:``}`}refresh(){for(let e of Xd){let t=Number(this.settings[e.key]),n=this.root.querySelector(`[data-range-key="${e.key}"]`),r=this.root.querySelector(`[data-number-key="${e.key}"]`),i=this.root.querySelector(`#${e.key}-output`);n&&(n.value=String(t)),r&&(r.value=String(Number(t.toFixed(3)))),i&&(i.textContent=this.formatValue(e,t))}for(let e of[`waterColor`,`sandColor`])this.root.querySelector(`[data-color-key="${e}"]`).value=this.settings[e],this.root.querySelector(`[data-color-text-key="${e}"]`).value=this.settings[e].toUpperCase();this.refreshCornerEditor();let e=this.root.querySelector(`#export-dimensions`);e.textContent=`${(this.settings.width*this.settings.exportScale).toFixed(1)} × ${(this.settings.depth*this.settings.exportScale).toFixed(1)} × ${(this.settings.height*this.settings.exportScale).toFixed(1)} units`}refreshCornerEditor(){let e=Math.max(.02,Math.min(this.settings.width,this.settings.depth)*.49),t=this.root.querySelector(`#corner-range`);t.max=String(e),t.value=String(this.settings.radii[this.selectedCorner]),this.root.querySelector(`#corner-output`).textContent=`${this.settings.radii[this.selectedCorner].toFixed(2)} m`,this.root.querySelector(`#selected-corner-name`).textContent={frontLeft:`Front left`,frontRight:`Front right`,backRight:`Back right`,backLeft:`Back left`}[this.selectedCorner];let n=this.root.querySelector(`#corner-preview`),r=this.root.querySelector(`#corner-preview-path`),i=this.settings.width/this.settings.depth,a=i>188/98?188:98*i,o=i>188/98?188/i:98,s=(240-a)*.5,c=18+(98-o)*.5,l=a/this.settings.width,u={frontLeft:Math.min(a*.48,this.settings.radii.frontLeft*l),frontRight:Math.min(a*.48,this.settings.radii.frontRight*l),backRight:Math.min(a*.48,this.settings.radii.backRight*l),backLeft:Math.min(a*.48,this.settings.radii.backLeft*l)},d=s+a,f=c+o;r.setAttribute(`d`,[`M ${s+u.backLeft} ${c}`,`L ${d-u.backRight} ${c}`,`Q ${d} ${c} ${d} ${c+u.backRight}`,`L ${d} ${f-u.frontRight}`,`Q ${d} ${f} ${d-u.frontRight} ${f}`,`L ${s+u.frontLeft} ${f}`,`Q ${s} ${f} ${s} ${f-u.frontLeft}`,`L ${s} ${c+u.backLeft}`,`Q ${s} ${c} ${s+u.backLeft} ${c}`,`Z`].join(` `));let p={backLeft:[s+8,c+8],backRight:[d-8,c+8],frontLeft:[s+8,f-8],frontRight:[d-8,f-8]};n.querySelectorAll(`[data-corner]`).forEach(e=>{let t=e.dataset.corner,[n,r]=p[t];e.setAttribute(`transform`,`translate(${n} ${r})`),e.classList.toggle(`is-selected`,t===this.selectedCorner)});let m=this.root.querySelector(`#corner-values`);m.innerHTML=Object.keys(this.settings.radii).map(e=>`<button type="button" data-corner-value="${e}" class="${e===this.selectedCorner?`is-selected`:``}"><span>${{frontLeft:`FL`,frontRight:`FR`,backRight:`BR`,backLeft:`BL`}[e]}</span><strong>${this.settings.radii[e].toFixed(2)}</strong></button>`).join(``),m.querySelectorAll(`[data-corner-value]`).forEach(e=>{e.addEventListener(`click`,()=>{this.selectedCorner=e.dataset.cornerValue,this.refreshCornerEditor()})})}},ef=`aquarium-studio-settings-v1`,tf=document.querySelector(`#viewer`),nf=document.querySelector(`.viewport`),rf=document.querySelector(`#control-panel`);if(!tf||!nf||!rf)throw Error(`Application shell is incomplete.`);var af=nf,of=rf;function sf(){let e=new URLSearchParams(window.location.hash.replace(/^#/,``)).get(`config`);if(e)try{let t=decodeURIComponent(escape(atob(e.replace(/-/g,`+`).replace(/_/g,`/`)))),n=JSON.parse(t);return Yd({...Jd(qd),...n,radii:{...qd.radii,...n.radii}})}catch{}try{let e=localStorage.getItem(ef);if(!e)return Jd(qd);let t=JSON.parse(e);return Yd({...Jd(qd),...t,radii:{...qd.radii,...t.radii}})}catch{return Jd(qd)}}var cf=sf(),lf=new _u({canvas:tf,antialias:!0,alpha:!0,powerPreference:`high-performance`});lf.setPixelRatio(Math.min(window.devicePixelRatio,2)),lf.outputColorSpace=Fe,lf.toneMapping=4,lf.toneMappingExposure=1.07,lf.shadowMap.enabled=!0,lf.shadowMap.type=2;var uf=new An,df=new Ao(34,1,.01,300),ff=new Ou(df,tf);ff.enableDamping=!0,ff.dampingFactor=.075,ff.minDistance=1,ff.maxDistance=80,ff.maxPolarAngle=Math.PI*.49,ff.target.set(0,cf.height*.42,0);var pf=new ws(lf),mf=pf.fromScene(new Vu,.04).texture;uf.environment=mf,pf.dispose();var hf=new vo(16777215,9085098,1.2);uf.add(hf);var gf=new Fo(16777215,3.3);gf.position.set(-7,11,-8),gf.castShadow=!0,gf.shadow.mapSize.set(2048,2048),gf.shadow.camera.near=.1,gf.shadow.camera.far=45,gf.shadow.bias=-8e-5,uf.add(gf);var _f=new qr(new Ra(120,120),new Ya({color:15331056,roughness:1,metalness:0}));_f.rotation.x=-Math.PI/2,_f.position.y=-.003,_f.receiveShadow=!0,uf.add(_f);var vf=null,yf=null,bf=0,xf=!0;function Sf(){localStorage.setItem(ef,JSON.stringify(cf))}function Cf(e=!1){vf&&(uf.remove(vf.group),vf.dispose()),vf=Ud(cf),yf=vf.group,uf.add(yf),Tf(),Sf(),(xf||e)&&(Of(`iso`),xf=!1)}function wf(e){window.clearTimeout(bf),bf=window.setTimeout(()=>Cf(e&&!1),e?55:90)}function Tf(){document.querySelector(`#dimension-stat`).textContent=`${cf.width.toFixed(1)} × ${cf.depth.toFixed(1)} × ${cf.height.toFixed(1)} m`,document.querySelector(`#triangle-stat`).textContent=`${vf?.triangles.toLocaleString()??`—`} triangles`}function Ef(e){if(!yf)return{position:new q(12,8,12),target:new q};let t=new Gn().setFromObject(yf),n=t.getSize(new q),r=t.getCenter(new q),i=Math.max(n.x,n.y,n.z),a=wt.degToRad(df.fov),o=i/(2*Math.tan(a/2)),s=o/Math.max(.35,df.aspect),c=Math.max(o,s)*1.22;return{position:r.clone().add(e.clone().normalize().multiplyScalar(c)),target:r}}function Df(e,t){let n=df.position.clone(),r=ff.target.clone(),i=performance.now();function a(o){let s=Math.min(1,(o-i)/360),c=1-(1-s)**3;df.position.lerpVectors(n,e,c),ff.target.lerpVectors(r,t,c),ff.update(),s<1&&requestAnimationFrame(a)}requestAnimationFrame(a)}function Of(e){let t=Ef({iso:new q(1.25,.82,1.45),front:new q(0,.18,1),side:new q(1,.18,0),top:new q(.001,1,.001),fit:df.position.clone().sub(ff.target).normalize()}[e]);Df(t.position,t.target)}function kf(e){let t=document.querySelector(`#toast`);t.textContent=e,t.classList.add(`is-visible`),window.setTimeout(()=>t.classList.remove(`is-visible`),2200)}function Af(){let e=JSON.stringify(cf);return btoa(unescape(encodeURIComponent(e))).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=+$/,``)}async function jf(){let e=new URL(window.location.href);e.hash=`config=${Af()}`,history.replaceState(null,``,e);try{await navigator.clipboard.writeText(e.toString()),kf(`Share link copied`)}catch{kf(`Settings added to the address bar`)}}function Mf(e){return e.trim().replace(/\.glb$/i,``).replace(/[^a-z0-9-_]+/gi,`-`).replace(/^-+|-+$/g,``)||`public-aquarium`}async function Nf(){if(!yf)return;let e=document.querySelector(`#loading-overlay`),t=document.querySelector(`#download-button`);e.hidden=!1,t.disabled=!0;try{let e=await Kd(yf,cf.exportScale),t=new Blob([e],{type:`model/gltf-binary`}),n=URL.createObjectURL(t),r=document.createElement(`a`),i=document.querySelector(`#file-name`);r.href=n,r.download=`${Mf(i.value)}.glb`,r.click(),window.setTimeout(()=>URL.revokeObjectURL(n),1e3),kf(`GLB downloaded`)}catch(e){console.error(e),kf(`Could not export the GLB`)}finally{e.hidden=!0,t.disabled=!1}}var Pf=new $d(of,cf,{onChange:(e,t)=>{cf=e,wf(t)},onReset:e=>{cf=e,history.replaceState(null,``,window.location.pathname+window.location.search),Cf(!0)},onShare:()=>void jf(),onDownload:()=>void Nf(),onView:Of});function Ff(){let e=af.clientWidth,t=af.clientHeight;lf.setSize(e,t,!1),df.aspect=e/Math.max(1,t),df.updateProjectionMatrix()}new ResizeObserver(Ff).observe(af),Ff();var If=!1;ff.addEventListener(`start`,()=>{If||(If=!0,document.querySelector(`#viewer-hint`)?.classList.add(`is-hidden`))});function Lf(){ff.update(),lf.render(uf,df),requestAnimationFrame(Lf)}Cf(!0),Pf.setSettings(cf),Lf(),window.addEventListener(`beforeunload`,()=>{vf?.dispose(),_f.geometry.dispose(),_f.material.dispose(),mf.dispose(),lf.dispose()});